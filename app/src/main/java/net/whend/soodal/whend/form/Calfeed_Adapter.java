...
public class Calfeed_Adapter extends ArrayAdapter<Calfeed>{
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		if(v==null){
			...
			Ids.date = (TextView)v.findViewById(R.id.feed_date);
	...
	//		Ids.btn_incalendar = (Button)v.findViewById(R.id.feed_incalendar);
		...
		if(il != null){
			...
			Ids.date.setText(il.getDateStart());
	...
	/*		Ids.btn_remove_from_wall.setOnClickListener(new View.OnClickListener() {
			...
			Bitmap bm = BitmapFactory.decodeFile("/sdcard"+il.getIconCompany(), options);
			Bitmap bm2 = BitmapFactory.decodeFile("/sdcard"+il.getIconContent(), options);

			
			Log.d("real","/sdcard"+il.getIconCompany());
			Log.d("real2","/sdcard"+il.getIconContent());
			
			
			if(bm != null)
					Ids.image_company.setImageBitmap(bm);
			else
				Ids.image_company.setImageResource(R.drawable.korea);
			...
			if(bm2 != null)
				...
				Ids.image_content.setImageResource(R.drawable.icon_whend);
